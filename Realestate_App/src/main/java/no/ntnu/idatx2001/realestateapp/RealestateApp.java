...
public class RealestateApp {
    ...
    private void findRealestateByOwner() {
        ...
        if (owner.isBlank() || owner.isEmpty()) {
            ...
            Iterator<Property> iProperty = this.properties.findAllPropertiesByOwner(owner);
            if(iProperty.hasNext()){
                while(iProperty.hasNext()){
                    Property prop = iProperty.next();
                    this.displayProperty(prop);
                }
            }else{
                System.out.println("Could not find any properties under this owner: "+ owner);
            }
        }
